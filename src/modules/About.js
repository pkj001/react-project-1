...
export default function About(props) {
  const [buttonText, setBtnTxt] = useState("change to light mode");
...
//  }
  return (
    <div className="container" style={{backgroundColor:props.mode==="dark"?"#042743": "white", color : props.mode==="dark"?"white ": "black" }}>
      ...
      {/* <button type="button"  className="btn btn-primary my-2">{buttonText}</button> */}
    </div>
  );
}
